 ...
 */
function whatIsIt(e){var t="test".constructor,o=[].constructor,n={}.constructor;return null===e?"null":e===undefined?"undefined":e.constructor===t?"string":e.constructor===o?"array":e.constructor===n?"object":"don't know"}function isJson(e){try{JSON.parse(e)}catch(t){return!1}return!0}function BrowserStorage(e){this.session=e||!1,this.save=function(e,t){this.session?"object"==whatIsIt(t)||"array"==whatIsIt(t)?sessionStorage.setItem(e,JSON.stringify(t)):sessionStorage.setItem(e,t):"object"==whatIsIt(t)||"array"==whatIsIt(t)?localStorage.setItem(e,JSON.stringify(t)):localStorage.setItem(e,t)},this.get=function(e){var t;return this.session?isJson(t=sessionStorage.getItem(e))?JSON.parse(t):t:isJson(t=localStorage.getItem(e))?JSON.parse(t):t},this.exists=function(e){return this.session?null!==sessionStorage.getItem(e):null!==localStorage.getItem(e)},this["delete"]=function(e){return this.session?sessionStorage.removeItem(e):localStorage.removeItem(e)}}function CookieStorage(){this.save=function(e,t){document.cookie=e+"="+t},this.get=function(e){for(var t=e+"=",o=decodeURIComponent(document.cookie).split(";"),n=0;n<o.length;n++){for(var i=o[n];" "==i.charAt(0);)i=i.substring(1);if(0==i.indexOf(t))return i.substring(t.length,i.length)}return""},this.exists=function(e){for(var t=e+"=",o=decodeURIComponent(document.cookie).split(";"),n=0;n<o.length;n++){for(var i=o[n];" "==i.charAt(0);)i=i.substring(1);if(0==i.indexOf(t))return!0}return!1},this["delete"]=function(e){document.cookie=e+"=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/"}}var storage;if("undefined"!=typeof Storage?storage=new BrowserStorage:(console.log("Your browser does not support local storage. Going to try cookies instead."),storage=new CookieStorage),"function"!=typeof _){console.log("Lodash was not found and is required by the fontstrap jQuery plugins.");var no_lodash=!0}$(".js-trigger").click(function(e){e.preventDefault()});var elementMissing=function(e,t){return 0===e.length&&(console.log("Element does not exist. Did not execute "+t+". Please check the selector."),!0)},buildTracker=function(e){return object={},_.times(e,function(e){object[e]=0}),object},newHeight=function(e){var t=0;return _.each(e,function(e){t<e&&(t=e)}),t},nextColumn=function(e){var o=0,n=e[0];return _.each(e,function(e,t){(0===t||e<n)&&(n=e,o=t)}),o},cleanSettings=function(e){return!_.isUndefined(e.spaceBetween)&&_.isString(e.spaceBetween)&&(e.spaceBetween=parseInt(e.spaceBetween.trim("px").trim("em").trim("rem"))),e};jQuery.fn.alignBlocks=function(e){if(no_lodash)return console.log("Lodash was not found and is required by the alignBlocks plugin."),!1;if(elementMissing($(this),"alignBlocks()"))return!1;var t=jQuery.extend({sm:576,md:768,lg:992,xl:1200}),n=jQuery.extend({countPerRow:4,countPerRowXs:1,countPerRowSm:2,countPerRowMd:3,countPerRowLg:4,countPerRowXl:5,responsive:!0,block:".list-item",spaceBetween:0},cleanSettings(e)),o=n.countPerRow;if(n.responsive){var i=$(window).width();switch(!0){case i<t.sm:o=n.countPerRowXs;break;case i<t.md:o=n.countPerRowSm;break;case i<t.lg:o=n.countPerRowMd;break;case i<t.xl:o=n.countPerRowLg;break;default:o=n.countPerRowXl}}var s=buildTracker(o),a=$(this),r=a.width(),c=_.floor(r/o),l=1<o?_.floor(c-n.spaceBetween*(o-1)/o):c;a.find(n.block).each(function(){var e=nextColumn(s),t=s[e],o=0===e?0:_.floor(e*l+n.spaceBetween*e);s[e]=t+$(this).outerHeight(!0),$(this).css({position:"absolute",top:t+"px",left:o+"px",width:l+"px"})}),a.css({position:"relative",height:newHeight(s)+"px"})},jQuery.fn.fullScreenBackground=function(e){if(no_lodash)return console.log("Lodash was not found and is required by the fullScreenBackground plugin."),!1;if(elementMissing($(this),"fullScreenBackground()"))return!1;var o=jQuery.extend({dataImageVar:"image"},e),t=$(this);_.each(t,function(e){var t=$(e).data(o.dataImageVar);t===undefined?console.log("fullScreenBackground: No image provided."):$(e).css({"background-image":"url('"+t+"')"})})},jQuery.fn.imagePopOut=function(e){if(no_lodash)return console.log("Lodash was not found and is required by the fullScreenBackground plugin."),!1;if(elementMissing($(this),"imagePopOut()"))return!1;var i=jQuery.extend({width:75,backdropEl:".image-pop-out-backdrop",imgContainerEl:".image-pop-out-container"},e),t=$(this),o=$("<i>").addClass("fa fa-times");closeBtn=$("<button>").addClass("image-pop-out-close-btn btn-sm bg-dark text-white").append(o),0==$(".image-pop-out-backdrop").length&&$("body").append($("<div>").addClass("fixed-full image-pop-out-backdrop")),0==$(".image-pop-out-container").length&&$("body").append($("<div>").addClass("fixed-full image-pop-out-container text-center")),$(i.imgContainerEl).click(function(){$(i.imgContainerEl).removeClass("open"),$(i.backdropEl).removeClass("open")}),$(".image-pop-out-close-btn").click(function(){$(i.imgContainerEl).removeClass("open"),$(i.backdropEl).removeClass("open")}),_.each(t,function(e){$img=$(e),$img.addClass("cursor-pointer"),$img.click(function(){var e=$(window).height(),t=new Image;t.src=$(this).attr("src"),$(i.imgContainerEl).html($("<div>").addClass("image-pop-out-wrapper").append($("<img>").addClass("pop-out-image").attr("src",t.src)).append(closeBtn)),$(i.backdropEl).addClass("open"),$(i.imgContainerEl).addClass("open");var o=e-$(".image-pop-out-wrapper").height();if(0<o){var n=o/2;$(".image-pop-out-wrapper").css({"margin-top":n})}else $(".pop-out-image").css({height:e});$(i.imgContainerEl+" img").click(function(e){e.stopPropagation()})})})},jQuery.fn.offcanvasMenu=function(e){function o(){var e=i.width;if(i.responsive){var t=$(window).width();switch(!0){case t<n.sm:e=i.xsWidth;break;case t<n.md:e=i.smWidth;break;case t<n.lg:e=i.mdWidth;break;case t<n.xl:e=i.lgWidth;break;default:e=i.xlWidth}}return e}if(no_lodash)return console.log("Lodash was not found and is required by the alignBlocks plugin."),!1;if(elementMissing($(this),"offcanvasMenu()"))return!1;var n=jQuery.extend({sm:576,md:768,lg:992,xl:1200}),i=jQuery.extend({width:25,xsWidth:75,smWidth:50,mdWidth:33,lgWidth:25,xlWidth:20,responsive:!0,pushContent:!1,mainBlock:".offcanvas-main-content",triggerEl:".offcanvas-menu-toggle",submenuTrigger:".submenu-toggle",submenuEl:".submenu",lockToggle:".menu-lock-toggle",cookieName:"menuLocked"},e);if(100<i.width||i.width<0)return console.log("width option is a percentage and should be between 0 and 100."),!1;var s=$(this),t=function(e){var t=o();s.animate({width:t+"%"},e),$(i.mainBlock).animate({"margin-left":t+"%"},e),$(".fixed-top, .fixed-bottom").animate({left:t+"%"},e),s.addClass("menu-open"),$(i.mainBlock).addClass("menu-open menu-open-"+t),i.push&&$(i.mainBlock).addClass("push")},a=function(e){var t=o();$(i.mainBlock).animate({"margin-left":0},e),$(".fixed-top, .fixed-bottom").animate({left:0},e),s.animate({width:0},e),s.removeClass("menu-open"),$(i.mainBlock).removeClass("menu-open menu-open-"+t),i.push&&$(i.mainBlock).removeClass("push")};if($(i.triggerEl).click(function(){s.hasClass("menu-open")?a():t()}),s.find(i.submenuTrigger+" > a").click(function(e){e.preventDefault(e),$(this).parent().siblings().find(i.submenuEl).removeClass("open"),$(this).parent().find(i.submenuEl).toggleClass("open"),$(this).parent().siblings().find("a").removeClass("active"),$(this).toggleClass("active")}),s.find(i.lockToggle).click(function(e){if(e.preventDefault(e),console.log($(this).hasClass("locked")),$(this).hasClass("locked")){$(this).removeClass("locked");var t=$("<i>").addClass("fa fa-unlock");$(this).find(".fa-lock").remove(),$(this).append(t),storage.save(i.cookieName,!1)}else{$(this).addClass("locked");var o=$("<i>").addClass("fa fa-lock");$(this).find(".fa-unlock").remove(),$(this).append(o),storage.save(i.cookieName,!0)}}),storage.get(i.cookieName)){$(i.lockToggle).addClass("locked");var r=$("<i>").addClass("fa fa-lock");$(i.lockToggle).find(".fa-unlock").remove(),$(i.lockToggle).append(r),t(0)}var c=_.throttle(t,250);$(window).resize(function(){s.hasClass("menu-open")&&c(0)})},jQuery.fn.keepAtTop=function(e){if(elementMissing($(this),"keepAtTop()"))return!1;var t=$(window),o=$(this),n=o.outerHeight(),i=o.offset().top,s=jQuery.extend({test:function(){t.scrollTop()>i?(o.addClass("stick-to-top"),$("body").css({"padding-top":n+"px"})):(o.removeClass("stick-to-top"),$("body").css({"padding-top":""}))}},e);t.scroll(function(){s.test()}),s.test()},jQuery.fn.keepAtBottom=function(e){if(elementMissing($(this),"keepAtBottom()"))return!1;var t=$(window),o=$(this),n=o.outerHeight(),i=o.offset().top+n,s=t.height(),a=jQuery.extend({test:function(){t.scrollTop()<i-s?(o.addClass("stick-to-bottom"),$("body").css({"padding-bottom":n+"px"})):(o.removeClass("stick-to-bottom"),$("body").css({"padding-bottom":""}))}},e);t.scroll(function(){a.test()}),a.test()},jQuery.fn.keepOnScreen=function(e){if(elementMissing($(this),"keepOnScreen()"))return!1;var t=$(window),o=$(this);t.on("beforeunload",function(){$(window).scrollTop(0)});var n=jQuery.extend({reset:function(){o.removeClass("stick-to-bottom"),o.removeClass("stick-to-top"),o.keepAtTop(),o.keepAtBottom()}},e);o.keepAtTop(),o.keepAtBottom(),t.resize(function(){n.reset()})},jQuery.fn.zoomIn=function(e){var d=jQuery.extend({magnification:2,minWidth:768,direction:"middle"},e);$(window).width()>=d.minWidth&&$(this).hover(function(){var e=d.magnification,t=d.direction;$(this).data("magnification-times")!==undefined&&(e=$(this).data("magnification-times")),$(this).data("magnification-direction")!==undefined&&(t=$(this).data("magnification-direction"));var o=parseInt($(this).width()),n=parseInt($(this).height()),i=n*e/2-n/2,s=o*e/2-o/2,a=$(window).scrollTop(),r=$(this).offset(),c=r.top-a,l={width:o*e+"px",position:"fixed",left:r.left,top:c,"z-index":"1002"};switch(t){case"up":l["margin-left"]="-"+s+"px",l["margin-top"]="-"+2*i+"px";break;case"down":l["margin-left"]="-"+s+"px",l["margin-bottom"]="-"+2*i+"px";break;case"left":l["margin-left"]="-"+2*s+"px",l["margin-top"]="-"+i+"px";break;case"right":l["margin-right"]="-"+2*s+"px",l["margin-top"]="-"+i+"px";break;default:l["margin-left"]="-"+s+"px",l["margin-top"]="-"+i+"px"}$(this).css(l),$("<div>").addClass("temporary-placeholder-div").css({width:o,height:n}).insertAfter($(this))},function(){$(this).removeAttr("style"),$(".temporary-placeholder-div").remove()})};
