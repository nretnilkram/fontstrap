 ...
 */
function whatIsIt(e){var t="test".constructor,o=[].constructor,n={}.constructor;return null===e?"null":e===undefined?"undefined":e.constructor===t?"string":e.constructor===o?"array":e.constructor===n?"object":"don't know"}function isJson(e){try{JSON.parse(e)}catch(t){return!1}return!0}function BrowserStorage(e){this.session=e||!1,this.save=function(e,t){this.session?"object"==whatIsIt(t)||"array"==whatIsIt(t)?sessionStorage.setItem(e,JSON.stringify(t)):sessionStorage.setItem(e,t):"object"==whatIsIt(t)||"array"==whatIsIt(t)?localStorage.setItem(e,JSON.stringify(t)):localStorage.setItem(e,t)},this.get=function(e){var t;return this.session?isJson(t=sessionStorage.getItem(e))?JSON.parse(t):t:isJson(t=localStorage.getItem(e))?JSON.parse(t):t},this.exists=function(e){return this.session?null!==sessionStorage.getItem(e):null!==localStorage.getItem(e)},this["delete"]=function(e){return this.session?sessionStorage.removeItem(e):localStorage.removeItem(e)}}function CookieStorage(){this.save=function(e,t){document.cookie=e+"="+t},this.get=function(e){for(var t=e+"=",o=decodeURIComponent(document.cookie).split(";"),n=0;n<o.length;n++){for(var i=o[n];" "==i.charAt(0);)i=i.substring(1);if(0==i.indexOf(t))return i.substring(t.length,i.length)}return""},this.exists=function(e){for(var t=e+"=",o=decodeURIComponent(document.cookie).split(";"),n=0;n<o.length;n++){for(var i=o[n];" "==i.charAt(0);)i=i.substring(1);if(0==i.indexOf(t))return!0}return!1},this["delete"]=function(e){document.cookie=e+"=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/"}}var storage;if("undefined"!=typeof Storage?storage=new BrowserStorage:(console.log("Your browser does not support local storage. Going to try cookies instead."),storage=new CookieStorage),"function"!=typeof _){console.log("Lodash was not found and is required by the fontstrap jQuery plugins.");var no_lodash=!0}$(".js-trigger").click(function(e){e.preventDefault()});var elementMissing=function(e,t){return 0===e.length&&(console.log("Element does not exist. Did not execute "+t+". Please check the selector."),!0)},buildTracker=function(e){return object={},_.times(e,function(e){object[e]=0}),object},newHeight=function(e){var t=0;return _.each(e,function(e){e>t&&(t=e)}),t},nextColumn=function(e){var t=0,o=e[0];return _.each(e,function(e,n){(0===n||e<o)&&(o=e,t=n)}),t},cleanSettings=function(e){return!_.isUndefined(e.spaceBetween)&&_.isString(e.spaceBetween)&&(e.spaceBetween=parseInt(e.spaceBetween.trim("px").trim("em").trim("rem"))),e};jQuery.fn.alignBlocks=function(e){if(no_lodash)return console.log("Lodash was not found and is required by the alignBlocks plugin."),!1;if(elementMissing($(this),"alignBlocks()"))return!1;var t=jQuery.extend({sm:576,md:768,lg:992,xl:1200}),o=jQuery.extend({countPerRow:4,countPerRowXs:1,countPerRowSm:2,countPerRowMd:3,countPerRowLg:4,countPerRowXl:5,responsive:!0,block:".list-item",spaceBetween:0},cleanSettings(e)),n=o.countPerRow;if(o.responsive){var i=$(window).width();switch(!0){case i<t.sm:n=o.countPerRowXs;break;case i<t.md:n=o.countPerRowSm;break;case i<t.lg:n=o.countPerRowMd;break;case i<t.xl:n=o.countPerRowLg;break;default:n=o.countPerRowXl}}var s=buildTracker(n),a=$(this),r=a.width(),c=_.floor(r/n),l=n>1?_.floor(c-o.spaceBetween*(n-1)/n):c;a.find(o.block).each(function(){var e=nextColumn(s),t=s[e],n=0===e?0:_.floor(e*l+o.spaceBetween*e);s[e]=t+$(this).outerHeight(!0),$(this).css({position:"absolute",top:t+"px",left:n+"px",width:l+"px"})}),a.css({position:"relative",height:newHeight(s)+"px"})},jQuery.fn.fullScreenBackground=function(e){if(no_lodash)return console.log("Lodash was not found and is required by the fullScreenBackground plugin."),!1;if(elementMissing($(this),"fullScreenBackground()"))return!1;var t=jQuery.extend({dataImageVar:"image"},e),o=$(this);_.each(o,function(e){var o=$(e).data(t.dataImageVar);$(e).css({"background-image":"url('"+o+"')"})})},jQuery.fn.imagePopOut=function(e){if(no_lodash)return console.log("Lodash was not found and is required by the fullScreenBackground plugin."),!1;if(elementMissing($(this),"imagePopOut()"))return!1;var t=jQuery.extend({width:75,backdropEl:".image-pop-out-backdrop",imgContainerEl:".image-pop-out-container"},e),o=$(this),n=$("<i>").addClass("fa fa-times");closeBtn=$("<button>").addClass("image-pop-out-close-btn btn-sm bg-dark text-white").append(n),0==$(".image-pop-out-backdrop").length&&$("body").append($("<div>").addClass("fixed-full image-pop-out-backdrop")),0==$(".image-pop-out-container").length&&$("body").append($("<div>").addClass("fixed-full image-pop-out-container text-center")),$(t.imgContainerEl).click(function(){$(t.imgContainerEl).removeClass("open"),$(t.backdropEl).removeClass("open")}),$(".image-pop-out-close-btn").click(function(){$(t.imgContainerEl).removeClass("open"),$(t.backdropEl).removeClass("open")}),_.each(o,function(e){$img=$(e),$img.addClass("cursor-pointer"),$img.click(function(){var e=$(window).height(),o=new Image;o.src=$(this).attr("src"),$(t.imgContainerEl).html($("<div>").addClass("image-pop-out-wrapper").append($("<img>").addClass("pop-out-image").attr("src",o.src)).append(closeBtn)),$(t.backdropEl).addClass("open"),$(t.imgContainerEl).addClass("open");var n=e-$(".image-pop-out-wrapper").height();if(n>0){var i=n/2;$(".image-pop-out-wrapper").css({"margin-top":i})}else $(".pop-out-image").css({height:e});$(t.imgContainerEl+" img").click(function(e){e.stopPropagation()})})})},jQuery.fn.offcanvasMenu=function(e){function t(){var e=n.width;if(n.responsive){var t=$(window).width();switch(!0){case t<o.sm:e=n.xsWidth;break;case t<o.md:e=n.smWidth;break;case t<o.lg:e=n.mdWidth;break;case t<o.xl:e=n.lgWidth;break;default:e=n.xlWidth}}return e}if(no_lodash)return console.log("Lodash was not found and is required by the alignBlocks plugin."),!1;if(elementMissing($(this),"offcanvasMenu()"))return!1;var o=jQuery.extend({sm:576,md:768,lg:992,xl:1200}),n=jQuery.extend({width:25,xsWidth:75,smWidth:50,mdWidth:33,lgWidth:25,xlWidth:20,responsive:!0,pushContent:!1,mainBlock:".offcanvas-main-content",triggerEl:".offcanvas-menu-toggle",submenuTrigger:".submenu-toggle",submenuEl:".submenu",lockToggle:".menu-lock-toggle",cookieName:"menuLocked"},e);if(n.width>100||n.width<0)return console.log("width option is a percentage and should be between 0 and 100."),!1;var i=$(this),s=function(e){var o=t();i.animate({width:o+"%"},e),$(n.mainBlock).animate({"margin-left":o+"%"},e),$(".fixed-top, .fixed-bottom").animate({left:o+"%"},e),i.addClass("menu-open"),$(n.mainBlock).addClass("menu-open menu-open-"+o),n.push&&$(n.mainBlock).addClass("push")},a=function(e){var o=t();$(n.mainBlock).animate({"margin-left":0},e),$(".fixed-top, .fixed-bottom").animate({left:0},e),i.animate({width:0},e),i.removeClass("menu-open"),$(n.mainBlock).removeClass("menu-open menu-open-"+o),n.push&&$(n.mainBlock).removeClass("push")};$(n.triggerEl).click(function(){i.hasClass("menu-open")?a():s()}),i.find(n.submenuTrigger+" > a").click(function(e){e.preventDefault(e),$(this).parent().siblings().find(n.submenuEl).removeClass("open"),$(this).parent().find(n.submenuEl).toggleClass("open"),$(this).parent().siblings().find("a").removeClass("active"),$(this).toggleClass("active")}),i.find(n.lockToggle).click(function(e){e.preventDefault(e),$(this).hasClass("locked")?($(this).removeClass("locked"),$(this).find(".fa").addClass("fa-unlock"),$(this).find(".fa").removeClass("fa-lock"),storage.save(n.cookieName,!1)):($(this).addClass("locked"),$(this).find(".fa").addClass("fa-lock"),$(this).find(".fa").removeClass("fa-unlock"),storage.save(n.cookieName,!0))}),storage.get(n.cookieName)&&($(n.lockToggle).addClass("locked"),$(n.lockToggle).find(".fa").addClass("fa-lock"),$(n.lockToggle).find(".fa").removeClass("fa-unlock"),s(0));var r=_.throttle(s,250);$(window).resize(function(){i.hasClass("menu-open")&&r(0)})},jQuery.fn.keepAtTop=function(e){if(elementMissing($(this),"keepAtTop()"))return!1;var t=$(window),o=$(this),n=o.outerHeight(),i=o.offset().top,s=jQuery.extend({test:function(){t.scrollTop()>i?(o.addClass("stick-to-top"),$("body").css({"padding-top":n+"px"})):(o.removeClass("stick-to-top"),$("body").css({"padding-top":""}))}},e);t.scroll(function(){s.test()}),s.test()},jQuery.fn.keepAtBottom=function(e){if(elementMissing($(this),"keepAtBottom()"))return!1;var t=$(window),o=$(this),n=o.outerHeight(),i=o.offset().top+n,s=t.height(),a=jQuery.extend({test:function(){t.scrollTop()<i-s?(o.addClass("stick-to-bottom"),$("body").css({"padding-bottom":n+"px"})):(o.removeClass("stick-to-bottom"),$("body").css({"padding-bottom":""}))}},e);t.scroll(function(){a.test()}),a.test()},jQuery.fn.keepOnScreen=function(e){if(elementMissing($(this),"keepOnScreen()"))return!1;var t=$(window),o=$(this);t.on("beforeunload",function(){$(window).scrollTop(0)});var n=jQuery.extend({reset:function(){o.removeClass("stick-to-bottom"),o.removeClass("stick-to-top"),o.keepAtTop(),o.keepAtBottom()}},e);o.keepAtTop(),o.keepAtBottom(),t.resize(function(){n.reset()})},jQuery.fn.zoomIn=function(e){var t=jQuery.extend({magnification:2,minWidth:768,direction:"middle"},e);$(window).width()>=t.minWidth&&$(this).hover(function(){var e=t.magnification,o=t.direction;$(this).data("magnification-times")!==undefined&&(e=$(this).data("magnification-times")),$(this).data("magnification-direction")!==undefined&&(o=$(this).data("magnification-direction"));var n=parseInt($(this).width()),i=parseInt($(this).height()),s=i*e/2-i/2,a=n*e/2-n/2,r=$(window).scrollTop(),c=$(this).offset(),l=c.top-r,d={width:n*e+"px",position:"fixed",left:c.left,top:l,"z-index":"1002"};switch(o){case"up":d["margin-left"]="-"+a+"px",d["margin-top"]="-"+2*s+"px";break;case"down":d["margin-left"]="-"+a+"px",d["margin-bottom"]="-"+2*s+"px";break;case"left":d["margin-left"]="-"+2*a+"px",d["margin-top"]="-"+s+"px";break;case"right":d["margin-right"]="-"+2*a+"px",d["margin-top"]="-"+s+"px";break;default:d["margin-left"]="-"+a+"px",d["margin-top"]="-"+s+"px"}$(this).css(d),$("<div>").addClass("temporary-placeholder-div").css({width:n,height:i}).insertAfter($(this))},function(){$(this).removeAttr("style"),$(".temporary-placeholder-div").remove()})};
